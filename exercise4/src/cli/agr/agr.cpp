  ...
  for (;;) {
    ...
    switch (vehicle_or_action) {
      case VehicleOrAction_car: {
        ...
        if (!car && vehicle_action != VehicleAction_create &&
            vehicle_action != VehicleAction_undefined) {
          std::cout
              << "In order to use this command you need to create a car ~grrr~"
              << std::endl;
          continue;
        }
        ...
        switch (vehicle_action) {
          case VehicleAction_create: {
            ...
            car =
                new CarAgr(opts.weight, opts.speed, opts.milage, opts.burning);
            break;
          }
          ...
          case VehicleAction_get_burning:
            std::cout << "Car burning: " << car->vehicle->burning()
                      << std::endl;
            break;
      ...
      case VehicleOrAction_bus: {
        ...
        if (!bus && vehicle_action != VehicleAction_create &&
            vehicle_action != VehicleAction_undefined) {
          std::cout
              << "In order to use this command you need to create a bus ~grrr~"
              << std::endl;
          continue;
        }
        ...
        switch (vehicle_action) {
          case VehicleAction_create: {
            ...
            bus =
                new BusAgr(opts.weight, opts.speed, opts.milage, opts.burning);
            break;
          }
          ...
          case VehicleAction_get_burning:
            std::cout << "Bus burning: " << bus->vehicle->burning()
                      << std::endl;
            break;
