...
static std::unordered_map<std::string, VehicleOrAction> __vehicle_or_action_strings__ = {
...
VehicleOrAction cast_vehicle_or_action(const std::string &str)
{
  ...
  return voa_iter != __vehicle_or_action_strings__.end() ? voa_iter->second : VehicleOrAction_undefined;
}
} // namespace agr
} // namespace cli
